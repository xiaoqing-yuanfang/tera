...
class ServerOptions : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_max_connection_count() const;
  inline void clear_max_connection_count();
  static const int kMaxConnectionCountFieldNumber = 8;
  inline ::google::protobuf::int64 max_connection_count() const;
  inline void set_max_connection_count(::google::protobuf::int64 value);
 ...
 private:
  ...
  inline void set_has_max_connection_count();
  inline void clear_has_max_connection_count();
